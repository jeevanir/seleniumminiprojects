...
public class TestCase7c {
	  ...
	  public String vEmail = "Berry123@tpg.com.au";
	...
	public void setUp() throws Exception {
	  ...
	  @Test
	  public void testTestCase7c() throws Exception {
	  ...
	  // 5. Click on 'View Order' 			   
	       ...
	       // switching to new window                                                                               
		    ...
		    driver.findElement(By.linkText("QTY")).clear();	
		    driver.findElement(By.linkText("Qty")).sendKeys("2"); 
		    for (String handle : driver.getWindowHandles()) {
		    	driver.switchTo().window(handle);
		    	} 
		   
		    //driver.findElement(By.xpath("//div[@class='page-title title-buttons']/span[text()='Cart']/following::span[1]"));
		    //baseUrl = "http://live.techpanda.org/index.php/sales/order/view/order_id/17141/";
		    driver.findElement(By.linkText("CART")).click();
		    driver.findElement(By.linkText("QTY")).sendKeys("1");
		    for (String handle : driver.getWindowHandles()) {
		    	driver.switchTo().window(handle);
		    	} 
		    
		    //input.get_attribute('2');
